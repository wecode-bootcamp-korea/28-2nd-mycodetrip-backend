    ...
    def get(self, request):
        ...
        try:
            ...
            result = {
                ...
                "type": "flight_list",
                "data": [{
                    "id"         : flight_seat.id, # 항공편 flight seat pk
                    ...
                    "price"      : int(flight_seat.price),
                    "tickets"    : flight_seat.stock, # 구매 가능한 티켓 수
                    "seat_type"  : flight_seat.seat_id, # 좌석 등급
                    "departure": {
                ...
                }  for flight in flights for flight_seat in flight.seats.all()],
            }
